...
patterns_established:
  - "ACL modification happens after keychain item creation, not during reads"
  - "Platform-specific identity code uses cfg(target_os = 'macos') guards with no-op stubs for other platforms"
  - "Production build detection uses TAURI_ENV_DEBUG = 'false' | '' | unset as production signal"
