...
patterns_established:
  - "Post-sync CRDT validation: validate after sync loop, reconcile to remove unauthorized data"
  - "Startup migration pattern: Tauri command called from App.svelte between swarmStore.initialize and activateDefaultSwarm"
