...
patterns_established:
  - "Message count diffing: track lastKnownCounts per channel key, slice new messages from previousCount"
  - "Focus-aware notification gating: skip notifications when window is focused"
